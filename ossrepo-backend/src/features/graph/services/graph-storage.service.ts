...
import {
  mapPrismaNodeToDto,
  mapPrismaSnapshotToDto,
} from '../utils/graph.mapper';
...
export class GraphStorageService {
  ...
  async deleteNodesBySnapshot(
    dto: DeleteNodesBySnapshotDto,
  ): Promise<{ count: number }> {
